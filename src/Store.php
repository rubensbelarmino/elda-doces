...
interface Store
{
    ...
    /**
     * Recupera os dados salvos de entrega do cliente associados ao seu ID.
     * Retorna array associativo com nome, e-mail, cpf, telefone e endereco completo, ou null se nao houver.
     */
    public function userDeliveryAddress(string $userId): ?array;

    /**
     * Persiste ou atualiza os dados de entrega de um cliente especifico no banco de dados.
     */
...
final class JsonStore implements Store
{
    ...
    /**
     * Obtem os dados de entrega salvos no cadastro JSON do cliente.
     */
    public function userDeliveryAddress(string $userId): ?array
    {
    ...
    /**
     * Grava ou atualiza os dados de entrega no arquivo JSON sob transacao atomica flock(LOCK_EX).
     */
    public function saveUserDeliveryAddress(string $userId, array $address): void
    {
...
final class MysqlStore implements Store
{
    ...
    /**
     * Recupera os dados de entrega serializados em JSON da tabela users no MySQL.
     */
    public function userDeliveryAddress(string $userId): ?array
    {
    ...
    /**
     * Atualiza os dados de entrega do usuario no MySQL com binding seguro de prepared statements.
     */
    public function saveUserDeliveryAddress(string $userId, array $address): void
    {
    ...
    private function migrate(): void
    {
        ...
        try { $this->pdo->exec('ALTER TABLE users ADD COLUMN IF NOT EXISTS delivery_json JSON NULL'); } catch (Throwable $e) {}
