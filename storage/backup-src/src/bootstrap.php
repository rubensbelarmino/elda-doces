...
/**
 * [Core Web Vitals & SEO] Retorna SVG transparente vetorial leve para evitar CLS (Cumulative Layout Shift).
 */
function image_placeholder(int $width = 900, int $height = 700): string 
{ 
