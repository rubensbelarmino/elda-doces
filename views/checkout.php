...
/**
 * ============================================================================
 * VIEW DE CHECKOUT & PAGAMENTO PIX — ELDA BOLOS E DOCES
 * ============================================================================
 * Formulario seguro para coleta de dados de entrega e geracao do PIX instantaneo.
 * Inclui preenchimento automatico de dados salvos e opcao de persistencia no perfil.
 * ============================================================================
 */
?>
    ...
    <div class="container">
        <form class="checkout-grid" method="post" action="/checkout">
            ...
            <div class="checkout-form">
                ...
                <!-- Opcao para salvar ou atualizar dados de entrega para proximas compras -->
